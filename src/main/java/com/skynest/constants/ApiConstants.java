...
public final class ApiConstants {
    ...
    public static final String USER_BY_ID_PATH = "/users/{uuid}";
    ...
    public static final String ENABLE_PATH = "users/{uuid}/enable";
    public static final String DISABLE_PATH = "users/{uuid}/disable";
}
